...
import io
# 上游写的是 `import ip2region.util as util`，但仓库里并没有 ip2region 这个包，
# ip2region 的工具函数就在同目录的 util.py。原样保留会让 import searcher 直接抛
# ModuleNotFoundError，导致 ip2region 离线兜底永远不生效。
import util
